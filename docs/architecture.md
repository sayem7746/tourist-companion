...
- **Database**: PostgreSQL (`users`, `tourist_profiles`, `trips`, `places`, `trip_places`, `itineraries`, `itinerary_days`, `itinerary_items`, `providers`, `referrals`, `arrival_checklist_items`, `concierge_messages`). Migrations live in `backend/migrations/`.
