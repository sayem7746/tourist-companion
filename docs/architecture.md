...
- **Frontend**: trip onboarding, dashboard, arrival checklist, concierge chat, nearby, itinerary, safety, ops login (`/admin/login`, `/admin`), content CMS (`/admin/content`), and searchable FAQ management (`/admin/faqs`).
