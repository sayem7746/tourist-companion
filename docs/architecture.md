...
- **Frontend**: trip onboarding, dashboard, arrival checklist, concierge chat, nearby, itinerary, safety, ops login (`/admin/login`, `/admin` with operational counts), content CMS (`/admin/content`), searchable FAQ management (`/admin/faqs`), partner listing management (`/admin/partners`), and an audit log (`/admin/audit`).
