...
- **Backend**: REST API with auth, trip context, places, itinerary, referrals (`POST /referrals/clicks`, `POST /referrals/leads`, `GET /r/:code`), and partner admin (`/admin/partners`).
